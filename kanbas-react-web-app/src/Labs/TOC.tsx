...
export default function TOC() {
  ...
  return (
    <ul className="nav nav-pills" id="wd-toc">
      ...
      <li className="nav-item"><a id="wd-github" href="https://github.com/briana-torres/kanbas-react-web-app" target="_blank"
          rel="noreferrer noopener" className="nav-link">My GitHub</a></li>
    </ul>
  );
}
